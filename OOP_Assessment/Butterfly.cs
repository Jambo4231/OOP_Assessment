...
namespace OOP_Assessment
{
    public class Butterfly : Event
    {
        ...
        public Butterfly(int eventNo, string venue, string eventDateTime, double record, string eventType, int distance, double winningTime)
        {
            EventNo = eventNo;
        ...
        public Butterfly(int eventNo, int venueID, string eventDateTime, double record, string eventType, int distance, double winningTime)
        {
            EventNo = eventNo;
