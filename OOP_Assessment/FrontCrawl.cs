...
namespace OOP_Assessment
{
    public class FrontCrawl : Event
    {
        ...
        public FrontCrawl(int eventNo, string venue, string eventDateTime, double record, string eventType, int distance, double winningTime)
        {
            EventNo = eventNo;
        ...
        public FrontCrawl(int eventNo, int venueID, string eventDateTime, double record, string eventType, int distance, double winningTime)
        {
            EventNo = eventNo;
