...
namespace OOP_Assessment
{
    public class BackStroke : Event
    {
        ...
        public BackStroke(int eventNo, string venue, string eventDateTime, double record, string eventType, int distance, double winningTime)
        {
            EventNo = eventNo;
        ...
        public BackStroke(int eventNo, int venueID, string eventDateTime, double record, string eventType, int distance, double winningTime)
        {
            EventNo = eventNo;
